...
\copy _tmp_dev_storage_buckets (id, name, owner, owner_id, public, avif_autodetection, file_size_limit, allowed_mime_types, bucket_type, created_at, updated_at) FROM 'C:/Users/abdal/Downloads/QMS/.release-artifacts/20260219-205414/dev-storage-buckets.csv' WITH (FORMAT csv, HEADER true);
