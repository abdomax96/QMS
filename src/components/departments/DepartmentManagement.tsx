...
const DEFAULT_DEPARTMENTS: Department[] = [
  { id: '1', code: 'QA', name: 'Quality Assurance', name_ar: 'ضمان الجودة', color: '#047857', icon: 'Award', is_active: true, display_order: 5 },
  { id: '2', code: 'QC', name: 'Quality Control', name_ar: 'مراقبة الجودة', color: '#059669', icon: 'CheckCircle', is_active: true, display_order: 6 },
  { id: '3', code: 'PROD', name: 'Production', name_ar: 'الإنتاج', color: '#B45309', icon: 'Factory', is_active: true, display_order: 10 },
  { id: '4', code: 'MAINT', name: 'Maintenance', name_ar: 'الصيانة', color: '#7C3AED', icon: 'Wrench', is_active: true, display_order: 20 },
  { id: '5', code: 'WH', name: 'Warehouse', name_ar: 'المستودع', color: '#0E7490', icon: 'Warehouse', is_active: true, display_order: 25 },
  { id: '6', code: 'LAB', name: 'Laboratory', name_ar: 'المختبر', color: '#BE185D', icon: 'FlaskConical', is_active: true, display_order: 30 },
  { id: '7', code: 'FS', name: 'Food Safety', name_ar: 'سلامة الغذاء', color: '#DC2626', icon: 'ShieldAlert', is_active: true, display_order: 35 },
  { id: '8', code: 'HR', name: 'Human Resources', name_ar: 'الموارد البشرية', color: '#6B7280', icon: 'Users', is_active: true, display_order: 40 },
  { id: '9', code: 'IT', name: 'Information Technology', name_ar: 'تقنية المعلومات', color: '#374151', icon: 'Server', is_active: true, display_order: 42 },
];
